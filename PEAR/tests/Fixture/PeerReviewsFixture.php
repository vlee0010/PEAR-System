 ...
 * PeerReviewsFixture
 */
class PeerReviewsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'date_reminder' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'peer_reviews_units_id_fk' => ['type' => 'index', 'columns' => ['unit_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'peer_reviews_units_id_fk' => ['type' => 'foreign', 'columns' => ['unit_id'], 'references' => ['units', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'date_start' => '2019-12-09 06:22:48',
                'date_end' => '2019-12-09 06:22:48',
                'date_reminder' => '2019-12-09 06:22:48',
